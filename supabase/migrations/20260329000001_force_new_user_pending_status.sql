-- Force new user profile status to pending at creation time.
-- This migration prevents stale handle_new_user definitions from creating active users before admin review.
...
BEGIN
  ...
  -- Step 3: create public.users profile (force pending until admin approval)
  BEGIN
